<!-- Modal -->
<div class="modal fade" id="deleteOptional" tabindex="-1" aria-labelledby="deleteOptionalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="deleteOptionalLabel">Conferma cancellazione optional</h1>
